...
MD_results_combined <- bind_rows(list(md_rep_results, md_dem_results, md_locations))
View(MD_results_combined)
...
```{r}
Cleaned_MD_results_combined <- MD_results_combined %>% 
  clean_names() 

glimpse (Cleaned_MD_results_combined)
```
...
Cleaned_MD_results_combined <- MD_results_combined %>% 
  ...
  left_join(MD_results_combined, by=c("county"="County_code")) 
```
