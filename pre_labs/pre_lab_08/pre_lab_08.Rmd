...
**Answer**
Give me the top 10 total differences and counties list
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
I see a disorganized bar chart showing counties and the column total differences
...
**Answer**
It's organized now but the county names still running over each other
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
The names are organized but now the bars are misplaced I would say
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** 
The background color has changed to white.
...
**Answer**
The background color has changed, but the brief data about the bar chart got closer to the name of the counties
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
Got a title, have a source, infos on left and bottom of the chart
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
date and the total contributions
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
a line chart of date and total contributions which is kind of cool
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
I can see the specific dates mentioned after 7 days or one week, but the distance between the texts are close and almost running over each other
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
Now the text is more organized and there's enough distance between them.
