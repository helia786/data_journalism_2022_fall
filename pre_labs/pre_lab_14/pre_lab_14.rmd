...
**Answer**
Reading the press release that has 999 releases which has the date, title, url and body-text
...
**Answer** This doesn't make any changes but show the words that are written differently
...
**Answer**
counts the number of words and it includes the characters that are mentioned in url by also counting them as words
...
**Answer** making chart of top 25 words used in the text which we want to get rid of
...
**Answer**
after removing stop words, this is the list of top 10 words, the number and the percentage of being repeated in the text. 
```{r}
unique_words %>%
...
**Answer**
The first data shows Covid, 19, and pandemic while the second data has Baltimore , and act, health
...
**Task** Run the following code and describe the results.
**Answer** it combines the words that mostly mentioned together in the text. It doesn't necessarily and always make sense, but overall it shows combinations of words that are mostly repeated. 
...
**Task** Run the following code and describe the results.
**Answer** The result is similar to 2021, but the number of words repeated changed. For instance, Covid 19, Human rights, etc. is less repeated compared to phrases repeated in 2021
...
**Answer**
Work, like, and a couple of words could be both positive and negative depending in the context it's used.
