...
**Answer**
The code below presents details for PG precincts and the column includes PRECINCT_ID, PRECINCT_NAME,CONGRESS, LEGIS, COUNCIL, SCHOOL, POLLING_ID, Shape_Length, Shape_Area,and Shape which has to do with the map of the county. 
...
**Answer**
It's just the same result as the previous question but opens in a new window looking more organized and everything in its own column. For example, each one of these PRECINCT_ID, PRECINCT_NAME,CONGRESS, LEGIS, COUNCIL, SCHOOL, POLLING_ID, Shape_Length, Shape_Area has its own column and data
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This installs the tigris package which allows me to directly download and use line shapefiles. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The code below displayed all counties with their detailed-information inlcuding GEOID, State, county, ect.
```{r}
...
I believe the code below just displayed the number of MD counties, its names, GEOID, and zip codes
...
It shows the map of the county
...
it added the layers on top of each other, I believe
...
**Task** Run the following code. Describe the output in the space below.
**Answer** 
It shows the county's precincts and its the details for its various election forms
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Join the precincts with the shapefiles
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
these are ghost precincts that have no eligible voters and its difference with dark blue precincts is that the dark blue precincts has few voters  
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
this shows the eligible voters by the county
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This shows the population for each county
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It shows the population of the MD county with the shapefiles
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Displayes population of each county by showing how many are eligible to vote
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It shows population geometry and counties of MD
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
It just left_joined various forms of voting
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
fixing the spelling of Saint Mary's and Baltimore County
...
calculating the number of voters per 10,000 population for each county and sorting them from highest to lowest
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
visualization of the previous question
...
Changing the color to see the difference clearer
...
**Answer**
Still working on colors to see the changes clearly
...
Now we want to focus the unaffiliated voters
...
and here we want to see the result on the map and visually
