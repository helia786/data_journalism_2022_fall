...
Combine all data together in one document
...
**Answer**
Population of each county in 2020
...
**Answer** two columns and 24 rows, but there should be nine and with the column total should be 10
...
**Answer** Haven't gotten any error 

```{r}
# join on zip - but there's a problem
#remember that the first column in a join comes from the first dataframe in the statement
...
**Answer** It's Prince George County and the number of democrats are 474841 which is like 78%.
...
**Answer** Howard County and the percentage is 52%. I believe with the decrease of the population, the percentage of democrtas also decreased.
